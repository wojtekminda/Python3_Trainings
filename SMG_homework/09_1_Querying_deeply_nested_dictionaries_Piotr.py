...
# PC: To jest dokladnie to rozwiazanie, o ktore mi chodzilo.
#     Jak widzisz jest bardzo proste, wiec mogles spokojnie
#     porwac sie na "additional challenge", ktory jest na dole
#     tresci zadania.
def fetch(nested_dictionary, path_of_keys):
    ...
    for key in path_of_keys_list:
        if key in nested_dictionary:
            ...
            # PC: Tego lepiej unikac. Juz lepiej zwrocic None.
            #     Alternatywnie mozna wypuszczac wyjatek (KeyError)
            #     lub zawsze zwracac z funkcji pare (wynik, blad), gdzie
            #     blad to info o bledzie lub None, jezeli nie bylo bledu.
            #     W ten sposob wolajacy funkcje moze sie zorientowac, ze
            #     cos poszlo inaczej niz zwykle.
